			...
			<ClerkProvider
				appearance={{
					elements: {
						...
						userButtonTrigger:
							"!h-10 !p-0 !w-full flex !justify-start group-data-[collapsible=icon]:hover:!bg-transparent group-data-[collapsible=icon]:!px-0 group-data-[collapsible=icon]:!bg-transparent group-data-[collapsible=icon]:!border-none transition-colors",
						userButtonBox:
